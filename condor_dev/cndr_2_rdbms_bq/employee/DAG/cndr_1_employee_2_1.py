...
# DAG Definition
dag = DAG(
    dag_id='CNDR_1_EMPLOYEE_2_1',
    default_args=default_dag_args,
    start_date=datetime(
        2025, 7, 31, 15, 19, tzinfo=local_tz
    ),
    catchup=False,
...
DIF_INGESTION = StartFlexTemplateCustomOperator(
    task_id = 'CNDR_1_EMPLOYEE_2_1_BASH_TASK',
    location = 'us-central1',
    project_id = 'dm-condor-dev',
    job_name = "cndr-1-employee-2-1-1519-m",
