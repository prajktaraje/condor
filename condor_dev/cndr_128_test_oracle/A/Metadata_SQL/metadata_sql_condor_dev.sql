INSERT INTO dataingestion_workflow (id, user_id, wf_id, wf_desc, wf_name, active, src_type_id, src_sub_type_id, trg_type_id, trg_sub_type_id, src_key, edit_action, trg_key, src_metadata, trg_metadata, created_ts, updated_ts, workflow_metadata, user_database_name, data_flow_props, business_unit, template_id, df_template_id, file_push_data, version) VALUES (128, 1, '128', 'test_oracle', 'test_oracle', 'False', 1, 1, 1, 1, 'projects/641772187113/secrets/cndr-prod-oracle-db', '{}', 'dm-condor-dev', '{"tbls_info":[{"Rows":null,"Table":"#T17_sid:287468553_4_FiltFilte","Average_row_size":"None"},{"Rows":6,"Table":"A","Average_row_size":"40960"},{"Rows":0,"Table":"AA2","Average_row_size":"0"}]}', '{}', '2025-06-04 11:50:04.304264', '2025-06-04 11:50:04.307032', '{"etl_steps":[]}', 'DM_PRODUCT', '{"region":"us-central1","network":"dm-primary-network","project":"dm-condor-dev","bq_dataset":"condor_dev","bq_project":"dm-condor-dev","subnetwork":"https://www.googleapis.com/compute/v1/projects/dm-network-host-project/regions/us-central1/subnetworks/subnet-dm-delivery-us-central1","code_bucket":"condor_dev_gcs","data_bucket":"condor_dev_gcs","num_workers":"1","temp_location":"gs://condor_dev_gcs/temp/","airflow_project":"dmgcp-del-composer","max_num_workers":"2","service_account":"sa-dataflow@dm-condor-dev.iam.gserviceaccount.com","staging_location":"gs://condor_dev_gcs/temp/","template_location":"gs://condor_dev_gcs/onix_condor_core_flex_template_v1.json","etl_dataset_region":"US","airflow_bucket_name":"dm-del-composer-bucket","worker_machine_type":"n1-standard-4","gcs_glossary_location":"condor_dev_gcs/condor_glossary_files/etlTest.json","gcs_dag_gen_folder_path":"dags/DM_CONDOR_DAGS/","scd_stored_procs_dataset":"condor_scd_procs","template_file_gcs_location":"gs://condor_dev_gcs/onix_condor_core_flex_template_v1.json","etl_processing_sqls_location":"gs://dm-del-composer-bucket/data/CONDOR_ETL_PROCESSING"}', NULL, 18, 1, NULL, NULL);INSERT INTO dataingestion_workflowjobtables (id, user_id, wf_id, job_id, col_id, job_name, job_tags, src_cust_schema, src_tbl_name, src_tbl_active, src_col_name, src_col_type, incr_cols, trg_tbl_name, target_col_name, target_col_type, target_col_active, dt_rules, tranformation_rules, is_scheduled, created_ts, updated_ts, action, split_col, clause, table_rules, split_col_format, incr_col_format, no_of_split, policy_tag, fetch_size, generated_col, sql_metadata, custom_dataflow_props, version, is_imported, raven_dag_name) VALUES (875, 1, '128', '88', '876', 'cndr_1_A_128_88', NULL, 'DM_PRODUCT', 'A', 'True', 'COL1', 'CHAR', 'False', 'A_test', 'COL1', 'STRING', 'True', NULL, NULL, 'False', '2025-06-05 05:54:18.292055', '2025-06-05 06:20:46.828061', 'add', 'False', '', '{"executionSteps":[{}],"use_incremental":false}', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'False', NULL);INSERT INTO dataingestion_workflowschedule (id, user_id, sch_id, wf_id, job_id, table_name, type, days, time, sch_json, dag_file_name, active, create_ts, upd_ts, create_usr, sch_date, group_name, dag_location, dag_code, version) VALUES (60, 1, '60', '128', '88', 'cndr_1_A_128_88', 'weekly', '', '11:25', '{"wf_id":"128","job_id":"88","frequency":[{"date":"2025-06-05","days":"","time":"11:25","type":"weekly","sch_id":"","intervals":"","operation":"edit"}],"table_name":"cndr_1_A_128_88"}', '', 'True', '2025-06-05 05:55:21.661367', '2025-06-05 06:21:46.274829', NULL, '2025-06-05', NULL, 'github/condor_dev/CNDR_1_A_128_88', '
...
# DAG Definition
dag = DAG(
    dag_id=''CNDR_1_A_128_88'',
    default_args=default_dag_args,
    start_date=datetime(
        2025, 6, 5, 11, 25, tzinfo=local_tz
    ),
    catchup=False,
...
DIF_INGESTION = StartFlexTemplateCustomOperator(
    task_id = ''CNDR_1_A_128_88_BASH_TASK'',
    location = ''us-central1'',
    project_id = ''dm-condor-dev'',
    job_name = "cndr-1-a-128-88-1125-w",
